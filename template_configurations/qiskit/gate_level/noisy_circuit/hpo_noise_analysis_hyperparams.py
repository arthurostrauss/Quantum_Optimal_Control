...
def setup_module_path():
    """
    This function adds the absolute path of the project directory to the system path if it is not already present.
    This ensures that the project modules can be imported correctly.
    """
...
if __name__ == "__main__":
    ...
    animation_file_path = "/Users/lukasvoss/Documents/Master Wirtschaftsphysik/Masterarbeit Yale-NUS CQT/Quantum_Optimal_Control/template_configurations/qiskit/gate_level/noisy_circuit/hpo_results/resource_constraint/max_hardware_runtime-600_07-05-2024/phi-0.5pi_gamma-0.01_maxruntime-600_custom-cost-value--15160.216284_timestamp_06-05-2024_22-28-05.pickle"

    ### Hyperparameter analysis ###
    directory_paths = [
        "/Users/lukasvoss/Documents/Master Wirtschaftsphysik/Masterarbeit Yale-NUS CQT/Quantum_Optimal_Control/template_configurations/qiskit/gate_level/noisy_circuit/hpo_results/resource_constraint/max_hardware_runtime-600_07-05-2024"
    ]
    specific_date = None
