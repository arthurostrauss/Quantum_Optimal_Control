...
from qiskit.circuit import QuantumCircuit, Parameter, ParameterVector, QuantumRegister, Gate
...
class QiskitConfig(BackendConfig):
    ...
    """
    parametrized_circuit: Callable[[QuantumCircuit, Optional[Sequence[Parameter] | ParameterVector],
                                    Optional[QuantumRegister], Any], None]
...
class TrainingConfig:
    """
    Training configuration. This is used to define all hyperparameters characterizing the Quantum Environment.
