...
class BaseParametrisedQuantumEnvironment(ABC, Env):
    ...
    def __init__(self, training_config: QEnvConfig):
        ...
        """
        self.extract_from_config(training_config)
    ...
    def extract_from_config(self, training_config):
    ...
    def perform_action(self, actions: np.array):
        ...
        qc = self.circuits[
            trunc_index
        ].copy()  # TODO: self.circuits needs to be updated
        ...
        return json.dumps(
            {
                ...
                "rl_reward_history": self.rl_reward_history,
