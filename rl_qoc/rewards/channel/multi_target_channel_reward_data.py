...
@dataclass
class MultiTargetChannelRewardData(RewardData):
    """
    Dataclass for storing MultiTarget channel reward data.
    ...
    target_preps: List[Pauli]  # Input Pauli for each target
...
@dataclass
class MultiTargetChannelRewardDataList(RewardDataList):
    """
    Dataclass for storing a list of MultiTarget channel reward data.
    """
