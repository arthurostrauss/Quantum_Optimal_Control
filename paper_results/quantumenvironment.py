...
class QuantumEnvironment:  # TODO: Build a PyEnvironment out of it
    def __init__(self, n_qubits: int, target_state: Dict[str, Union[str, DensityMatrix]], abstraction_level: str,
                 backend: IBMBackend, service: QiskitRuntimeService, parametrized_circuit: Callable,
        ...
        :param service: Qiskit Runtime Service instance
        :param parametrized_circuit: Python function generating Qiskit parametrized quantum circuit
        :param options: Options to put in Qiskit Estimator primitive
